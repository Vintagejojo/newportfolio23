                ...
                <div className="flex flex-row md:flex-col justify-center align-top items-stretch">
                    ...
                    <h2 className=" text-2xl font-bold mb-8 sm:mb-4 text-center text-generalbg">
                        ...
                        <p>Hey there friends my name is Jordan and I am an
                            <span className="font-extrabold"> aspiring </span> and
                            <span className="font-extrabold"> attentive </span> web developer who likes to
                            <span className="font-extrabold"> tinker. </span> Equal parts Herbalist and Technocrat.
                        </p>
                        <br />
                        <br />
                        <p>
